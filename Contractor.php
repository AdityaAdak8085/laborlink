...
<body>
    ...
    <div class="container">
        ...
        <div class="contractor-list">
            ...
            $mysqli = new mysqli('localhost', 'root','Adi@8085', 'laborlink');
            ...
            $result = $mysqli->query("SELECT labor_name, contact_number, labor_address, experience,profession FROM labor_users");

            // Output details for each contractor
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo '<div class="contractor">';
                    echo '<h3>' . $row["labor_name"] . '</h3>';
